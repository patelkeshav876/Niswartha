...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { 
        path: 'admin/needs',
        element: <AdminRoute><ManageNeeds /></AdminRoute>,
      },
      { 
        path: 'admin/events',
      ...
      { 
        path: 'admin/events/bookings/:id',
        element: <AdminRoute><EventBookings /></AdminRoute>,
      },
      { 
      ...
      { 
        path: 'admin/feed',
        element: <AdminRoute><FeedManagement /></AdminRoute>,
      },
      { 
        path: 'admin/settings',
